...
def get_model(x, y, model_config):
    if model_config["model"]["type"] == "regression":
        ...
        neural_net_model.train(x, y, model_config["model"]["alpha"], model_config["model"]["hidden_layer_sizes"], model_config["model"]["learning_rate"], model_config["model"]["max_iter"], model_config["model"]["batch_size"], model_config["model"]["verbose"])
